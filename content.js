...
const CONTENT = {
  ...
  en: {
    ...
    fondation: {
      ...
      tally: "explored",
      pois: [
        { label: "Faouëdic enclosure", coord: { x: 45, y: 58 }, date: "27 August 1666", title: "The first palisade",
        ...
        { label: "Scorff shipyards", coord: { x: 32, y: 42 }, date: "1668", title: "Cradle of the three-masters",
        ...
        { label: "Soleil d'Orient", coord: { x: 68, y: 32 }, date: "1670", title: "The naming ship",
        ...
        { label: "Port-Louis Citadel", coord: { x: 78, y: 72 }, date: "1591 — kept by the Indies",
        ...
        { label: "Company counter", coord: { x: 50, y: 50 }, date: "1675",
